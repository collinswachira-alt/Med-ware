        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className="bg-gradient-to-r from-blue-600 to-sky-500 text-white px-6 py-2.5 rounded-lg hover:shadow-lg transform hover:-translate-y-0.5 transition-all font-medium">
                Sign In
              </button>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden pb-4 space-y-3 animate-in slide-in-from-top">
              ...
              <button className="w-full bg-gradient-to-r from-blue-600 to-sky-500 text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all font-medium">
                Sign In
              </button>
            </div>
          )}
